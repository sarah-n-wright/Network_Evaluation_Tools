...
# -*- coding: utf-8 -*-
#
# neteval documentation build configuration file, created by
...
init_file = os.path.join('..', 'neteval', '__init__.py')
...
latex_documents = [
    (master_doc, 'neteval.tex',
     u'Network Evaluations Tools v2 Documentation',
     u'Sarah Wright', 'manual'),
]
